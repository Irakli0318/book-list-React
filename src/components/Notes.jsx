...
function Notes({bookId}) {
    ...
    const  fetchNote = async(book_id)=>{
      ...
      try{const q = query(collection(db, "notes"), where("book_id", "==", book_id));
    ...
    return (
      <>
        ...
        <div className="notes-wrapper">
            ...
            <div>
              <p>Eror there is no fetching note from the data.</p>
            </div>
            :
